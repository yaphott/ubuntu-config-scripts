...
register_task 'NVIDIA Container Toolkit' install    "bash -e '$project_dir/bin/install_nvidia_container_toolkit.sh' '$NVIDIA_CONTAINER_TOOLKIT_VERSION'" true
register_task 'NVIDIA Container Toolkit' configure  "bash -e '$project_dir/bin/configure_nvidia_container_toolkit.sh'" true
