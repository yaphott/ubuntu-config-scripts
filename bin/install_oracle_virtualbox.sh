...
bash "$REPO_UTILS_PATH"'/add_repository.sh' 'deb [arch=amd64 signed-by='"$KEYRINGS_PATH"'/'"$key_filename"'] https://download.virtualbox.org/virtualbox/debian '"$( lsb_release -cs )"' contrib' \
                                            "$repo_filename"
